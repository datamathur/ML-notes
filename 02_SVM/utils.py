...
class Dataset:
    ...
    --------
    `data()`:
        returns splitted diabetes data for regression and breast cancer data for classification
    '''
    ...
    # Loads the Breast Cancer dataset and returns features and targets for train and test dataset.
